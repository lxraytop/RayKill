window.config={
	extension_sources:{
		GitHub:'https://raw.githubusercontent.com/lxraytop/raykill-extension/master/',
	},
	...
	all:{
		...
		stockmode:['identity','th_mougong','guozhan','versus','boss','doudizhu','single','connect','brawl','huanhuazhizhan'],
	...
	characters:['standard','refresh','shenhua','xinghuoliaoyuan','yijiang','sp','yingbian','clan','huicui','xianding','sp2','extra','mobile','shiji','sb','tw','collab','offline','jsrg','old','ddd'],
	connect_characters:['diy','mrfz'],
	connect_cards:['guozhan','sp','zhulu','yingbian','yongjian','mrfz'],
	plays:[],
	extensions:['全能搜索','扩展导入','UIPro','模式设置','菜单UI'],
	'extension_扩展导入_enable':true,
	banned:[],
	bannedcards:[],
	forbidlist:[],
	bannedpile:{},
