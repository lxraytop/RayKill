...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		character:{
			...
			jiaowanb:["male","wu",3,["iriya_yinji","iriya_haozhi"]],
			jcaocao:["male","wei",4,["nsjianxiong"]],
			rayliushan:["male","shu",4,["ao_xishi"]],
			cenhanzhi_a:["female","wu",3,["nk_shekong"]],
			wanyunwei_a:["male","shu",4,["key_huanjie","haruko_haofang"]],
			chuxingyao_a:["female","shu",3,["umi_lunhui","haruko_zhuishi"]],
			yean_a:["male","shu",4,["yukine_wenzhou"]],
			guanlingwen_a:["male","wei",3,["iwasawa_yinhang","masato_baoquan"]],
			zailan_a:["female","wei",3,["yusa_yanyi","yusa_misa"]],
			yuyiqing_a:["male","wei",3,["komari_xueshang"]],
			qiuju_a:["male","shu",5,["yui_jiang"]],
			chenyanchao_a:["male","wu",4,["yui_lieyin"]],
			minbeizhu_a:["female","shu",3,["shiina_qingshen","shiina_feiyan"]],
			peiyanhe_a:["male","shu",3,["akane_jugu"]],
			youlang_a:["male","wei",4,["sasami_baoqiu"]],
			lushuyi_a:["male","wei",3,["yuiko_dilve","yuiko_dilve"]],
			yuejiayi_a:["female","wei",3,["ayato_zonghuan","riki_wenji"]],
			yuchengji_a:["female","wu",4,["ao_kuihun","ao_shixin","ao_diegui"]],
			jiaowanbb:["male","shen",3,["misa_yehuo","iwasawa_fenyin"]],
			jiaowanc:["male","wu",4,["liyingxia_sanli"]]
		},
		characterSort:{
			diy:{
				diy_noname:['noname'],
				jiaowan:['jiaowana','jiaowanb','jiaowanbb'],
				sanguoray:['jcaocao','rayliushan'],
				boxuan:['boxuana','cenhanzhi_a','wanyunwei_a','wanyunwei_a','chuxingyao_a','yean_a','guanlingwen_a','zailan_a','yuyiqing_a','qiuju_a','chenyanchao_a','minbeizhu_a','peiyanhe_a','youlang_a','yuejiayi_a','yuchengji_a','lushuyi_a']
			},
		},
		characterIntro:{
			noname:'开发不易，感谢各位的赞赏！',
		...
		skill:{
			...
			iriya_yinji:{
				...
				content:function(){
					player.drawTo(12).gaintag=['iriya_yinji_tag'];
