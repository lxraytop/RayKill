            ...
            class Searcher {
                ...
                constructor(target) {
                    ...
                    this.input.addEventListener('animationend', function(e) {
                        if (e.animationName == 'wrong') this.classList.remove('wrong');
                    });
                    ...
                    let updateDescription = () => {
                        ...
                        for (let data of alwaysShow) {
                            if (!this.searchList.contains(data) || !data.startsWith(this.input.value) || this.input.value == data) {
                                continue;
                            }
                        ...
                        if (e.key == 'Enter') {
                            ...
                            if (!key) {
                                ...
                                for (const item of this.searchList) {
                                    if (item.startsWith(this.input.value) && this.input.value.length > 0 && this.input.value != item) {
                ...
                findCharacter(result, hide) {
                    ...
                    if (this.dialog.content.childElementCount == 0) hide = false;

                    const qnssCaption = ui.create.div('.caption.qnssCaption', this.dialog.content);
                    ...
                    for (const data of name) {
                            ...
                            if (lib.translate[skill]) {
                                skillstr +=
                                    `<li>
                                        ...
                                        <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextSibling)">技能描述&nbsp</font><span>${lib.translate[skill + '_info']}</span>
                                        </br>

                                        <font color=\"#96CAFF\">技能语音&nbsp</font>
                                        ...
                                        <font color=\"#96CAFF\">技能代码&nbsp</font>
                        ...
                        for (const derivation of skillDerivation) {
                            skillDerivationstr +=
                                `<li>
                                    ...
                                    <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextSibling)">技能描述&nbsp</font><span>${lib.translate[derivation + '_info']}</span></br>
                                    <font color=\"#96CAFF\">技能语音&nbsp</font>
                        ...
                        const buttons = ui.create.div('.buttons'/*, this.dialog.content*/);
                        buttons.classList.add('smallzoom');
                        this.dialog.buttons = this.dialog.buttons.concat(ui.create.buttons([charName], 'character', buttons, false));
                        ...
                        d.insertAdjacentHTML('afterbegin', `
                            ...
                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextSibling)">武将信息&nbsp</font>
                            <span>${get.characterIntro(charName)}</span>
                            </br>

                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextElementSibling.nextElementSibling.this.nextElementSibling.nextElementSibling)">所在武将包&nbsp</font>
                            ...
                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextElementSibling.nextElementSibling)">武将名称&nbsp</font>
                            ...
                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextSibling)">武将称号&nbsp</font>
                            <span>${get.colorspan(lib.characterTitle[charName] || "暂无称号")}</span>
                            </br>

                            <font color=\"#96CAFF\">武将性别&nbsp</font><span>${lib.translate[character[0]]}</span>
                            </br>

                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextElementSibling.nextElementSibling)">武将势力&nbsp</font>
                            ...
                            <font color=\"#96CAFF\">体力上限&nbsp</font><span>${character[2]}</span>
                            </br>
                                        
                            <font color=\"#96CAFF\">阵亡语音&nbsp</font>
                            <img src='${layoutPath}img/qhly_pic_playaudiobutton.png' alt='点击播放阵亡语音' onclick='
                                "use strict";
                                let findInExt = false;
                            ...
                            style='position: absolute; width: 100px; margin: 0; padding: 0;' />
                            </br>

                            <font color=\"#96CAFF\">武将技能</font>${skillstr}
                            </br>

                            <font color=\"#96CAFF\">武将衍生技</font><span>${skillDerivationstr.length > 0 ? skillDerivationstr : '无'}</span>
                    ...
                    if (hide) {
                        // @ts-ignore
                        Array.from(fragment.childNodes).forEach(ele => ele.style && (ele.style.display = 'none'));
                    }

                    this.dialog.content.appendChild(fragment);
                    console.timeEnd('findCharacter');
                }
                /** 寻找卡牌 */
                findCard(result, hide) {
                    ...
                    for (const data of name) {
                        ...
                        */
                        ...
                        d.insertAdjacentHTML('afterbegin', `
                            ...
                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextElementSibling.nextElementSibling)">卡牌名称</font>
                            ...
                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextElementSibling.nextElementSibling)">卡牌类别</font>
                            ...
                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextSibling)">卡牌效果</font>${nature ? lib.card.sha.cardPrompt({ name: 'sha', nature }) : lib.translate[cardName + '_info']}
                            </br>
                            
                            <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextElementSibling.nextElementSibling)">所在卡牌包</font>${packTranslate || '无'}
                            <font color=6df95b>[ </font>
                            ...
                            ${cardData.derivation ? (
                                '<font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextElementSibling.nextElementSibling)">卡牌来源</font>' + lib.translate[cardData.derivation] +
                                '<font color="6df95b"> [ </font>' +
                            ...
                            <img src='${layoutPath}img/qhly_pic_playaudiobutton.png' alt='卡牌语音（男）' onclick="
                                ...
                                if('${cardName}' == 'sha' && ['fire', 'thunder', 'ice'].includes('${nature}') ){
                                    ...
                                    if (typeof audioinfo == 'string') {
                                        ...
                                        game.playAudio('card', 'male', '${cardName}');
                                    }
                                }
                            " style='position: absolute; width: 100px; margin: 0; padding: 0;' />
                            </br>

                            <font color=\"#96CAFF\">卡牌语音（女）</font>：
                            <img src='${layoutPath}img/qhly_pic_playaudiobutton.png' alt='卡牌语音（女）' onclick="
                                ...
                                if('${cardName}' == 'sha' && ['fire', 'thunder', 'ice'].includes('${nature}') ){
                                    ...
                                    if (typeof audioinfo == 'string') {
                                        if (audioinfo.indexOf('ext:') == 0) game.playAudio('..', 'extension', audioinfo.slice(4), '${cardName}_female');
                                        else game.playAudio('card', 'female', audioinfo);
                                    }
                                    else {
                                        game.playAudio('card', 'female', '${cardName}');
                                    }
                                }
                            " style='position: absolute; width: 100px; margin: 0; padding: 0;' />
                            </br>

                            <font color=\"#96CAFF\">卡牌代码</font>
                ...
                findSkill(result, hide) {
                    ...
                    for (let skillName in lib.skill) {
                        ...
                        if (typeof lib.translate[skillName] != 'string') continue;
                        // 中文包含的，或者英文id对应的
                        if (lib.translate[skillName].includes(result) || skillName === result) skills.push({
                            skillName,
                            translate: lib.translate[skillName],
                            info: lib.translate[skillName + '_info'],
                    ...
                    for (let i = 0; i < skills.length; i++) {
                        ...
                        d.insertAdjacentHTML('afterbegin', `
                            <li>
                                ...
                                <font color=\"#96CAFF\" ondblclick="game.全能搜索_copy(this.nextSibling)">技能描述</font>：${info}</br>
                                <font color=\"#96CAFF\">技能语音</font>：
                                ...
                                <font color=\"#96CAFF\">技能拥有者</font>：<div id="replaceCharacters"></div></br>
                                <font color=\"#96CAFF\">技能代码</font>：
                                <a onclick='window.qnssShowCode.call(this)'>点击查看技能代码</a>
                            </li>
                        ...
                        if (get.objtype(lib.description) === 'object') {
                            ...
                            if (!descriptionObj) {
                                ...
                                if (exceptDescriptionResult && exceptDescriptionResult[qnssKeySymbol]) {
                                    ...
                                    descriptionStr += `
                                        <font color=\"#96CAFF\">代码描述</font>：<span>${descriptionResult}</span></br>
                                    `;
                                }
                            }
                            else if (typeof descriptionObj === 'string') {
                                descriptionStr += `
                                    <font color=\"#96CAFF\">代码描述</font>：<span>${descriptionObj}</span></br>
                                `;
                            }
                                ...
                                if (descriptionObj.description) {
                                    descriptionStr += `
                                        <font color=\"#96CAFF\">代码描述</font>：<span>${descriptionObj.description}</span></br>
                                    `;
                                }
                                // 如果此api是函数，且有对此api返回值的注释
                                if (typeof obj == 'function' && descriptionObj.return) {
                                    descriptionStr += `
                                        <font color=\"#96CAFF\">函数返回值</font>：
                                    `;
                                    if (get.objtype(descriptionObj.return) !== 'object') {
                                        ...
                                        descriptionStr += `
                                            <li style="padding-left: 50px;">
                                                <font color=\"#96CAFF\">返回值类型</font>: <span>${descriptionObj.return.type || '未知'}</span>
                                            </li>
                                            <li style="padding-left: 50px;">
                                                <font color=\"#96CAFF\">返回值描述</font>: <span>${descriptionObj.return.description || '未知'}</span>
                                            </li>
                                        `;
                                    }
                                    descriptionStr += '</br>';
                                    ...
                                    for (const key in descriptionObj.args) {
                                        ...
                                        descriptionStr += `
                                            <li style="padding-left: 50px;">
                                                ...
                                                <font color=\"#96CAFF\">参数描述</font>：${arg.description || '暂无注释'}</br>
                                                <font color=\"#96CAFF\">参数类型</font>：${arg.type || '暂无注释'}</br>
                                                <font color=\"#96CAFF\">是否必须存在</font>：${arg.exist === true ? '是' : arg.exist === false ? '否' : '暂无注释'}</br>
                                                <font color=\"#96CAFF\">参数顺序</font>：${arg.index == 'allRight' ? '任一顺序皆可' : arg.index ? ('第' + arg.index + '位') : '暂无注释'}</br>
                                            </li>
                                        `;
                                    }
                                }
                                ...
                                if (descriptionObj && descriptionObj[window.qnssDescriptionSymbol]) {
                                    descriptionStr += `
                                        <font color=\"#96CAFF\">代码描述</font>：<span>${descriptionObj[
                                        // @ts-ignore
                ...
                tujianBegin(dialog, result, canAddToDataList) {
                    ...
                    let resultCard = containsKey('findCard') ? this.findCard(result, this.searcherModule.length > 1 ? ('findCard' !== this.searcherModule[0]) : false) : false;
                    let resultSKill = containsKey('findSkill') ? this.findSkill(result, this.searcherModule.length > 1 ? ('findSkill' !== this.searcherModule[0]) : false) : false;
                    let resultCode = containsKey('findCode') ? this.findCode(result, this.searcherModule.length > 1 ? ('findCode' !== this.searcherModule[0]) : false) : false;
