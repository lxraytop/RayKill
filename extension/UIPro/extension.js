...
game.import("extension", function(lib, game, ui, get, ai, _status) {
    window.url = {
        url: lib.assetURL + "extension/UIPro",
    };
	const decadeUIName = 'UIPro', decadeUIPath = window.decadeUIPath = `${lib.assetURL}extension/${decadeUIName}/`, Mixin = window.Mixin = {
		/**
		 * @param {string} method
    ...
    return {
        ...
        content: function(config, pack) {
            'use strict';
            delete lib.extensionMenu['extension_UIPro'].delete;
            /*-----------------分割线-----------------*/
            lib.arenaReady.push(function() { //联机禁用开始
                if (_status.connectMode === true) {} else {
                    ...
                    function changeSSName(obj) {
                        ...
                        if (len > 0) {
                            for (let i = 0; i < len; i++) {
                                ...
                                if (key) l[key] = obj[key];
                            }
                        }
                    }

                    changeSSName(character);

			lib.skill._gifting = { //修复未开启用间卡牌报错
				enable:'phaseUse',
				forceLoad:true,
				...
				ai:{
                    ...
                    lib.skill._longLevel = {
                        ...
                        filter: function(event, player) {
                            return (lib.config.extension_UIPro_longLevel == 'sex') || (lib.config.extension_UIPro_longLevel == 'seven');
                        },
                        content: function() {
                            if (lib.config.extension_UIPro_longLevel == 'seven') {
                            ...
                            if (lib.config.extension_UIPro_longLevel == 'sex') {
                    ...
                    lib.skill._check_dynamicSkin_Player = {
                        ...
                        charlotte: true,
                        filter: function(event, player) {
                            return !player.doubleAvatar && player.dynamic && lib.config['extension_UIPro_newDecadeStyle'] == "off"
                        },
                        content: function() {
                            if (Object.keys(player.getElementsByClassName("skinYh"))
                                .length <= 0) {
                    ...
                    lib.skill._dieAfter_dynamicSkin_Player = {
                        ...
                        priority: -1,
                        filter: function(event, player) {
                            return !player.doubleAvatar && (lib.config.extension_UIPro_dynamicSkin_dieAfter == true) && player.dynamic && lib.config['extension_UIPro_newDecadeStyle'] == "off"
                        },
                        content: function() {
                            if (Object.keys(player.getElementsByClassName("skinYh"))
                                .length <= 0) {
                    ...
                    lib.skill._revive_dynamicSkin_Player = {
                        ...
                        charlotte: true,
                        filter: function(event, player) {
                            return (lib.config.extension_UIPro_dynamicSkin_dieAfter == true) && player.dynamic && lib.config['extension_UIPro_newDecadeStyle'] == "off"
                        },
                        content: function() {
                            if (Object.keys(player.getElementsByClassName("skinYh"))
                                .length > 0) {
  ...
  //结束
			...
			if (['tafang', 'chess'].includes(get.mode()) && lib.config.extension_UIPro_closeWhenChess) return;
            ...
            switch (lib.config.layout) {
                ...
                case 'mobile':
                    break;
                default:
                    alert('UIPro提醒您，请使用<默认>、<手杀>、<新版>布局以获得良好体验（在选项-外观-布局中调整）。');
                    break;
            }
            ...
            window.dui = window.decadeUI = {
                ...
                initOverride: function() {
                    ...
                    var Player = (function(Player) {
                        ...
                        //开始
                        if (lib.config.mode != 'connect' && game.getExtensionConfig('EngEX', 'enable')) {} else {
                            Player.init = function(character, character2, skill, update) {
                                ...
                                if (character && duicfg.showJieMark) {
                                    if (lib.characterPack.refresh) jie = lib.characterPack.refresh[character];
                                    if (jie == null) {
                                    ...
                                    if (jie != null) {
                                        ...
                                        if (jie == '界') {
                                            if (this.$jieMark == undefined) this.$jieMark = dui.element.create('jie-mark', this);
                        ...
                        Player.update = function(count, hp, hpMax, hujia) {
                            if (!_status.video) {
                                ...
                                if (this.hujia > 0) {
                                    //if(lib.config.extension_UIPro_newDecadeStyle=='on') this.markSkill('ghujia');
                                    //else{
                                    if (!hujiat) {
                                    /*if(lib.config.extension_UIPro_newDecadeStyle=='on'){
                                ...
                                /*f(lib.config.extension_UIPro_newDecadeStyle=='on'){
								...
								hpWrap.appendChild(this.node.hp);
                                    ...
                                    //if(lib.config.extension_UIPro_newDecadeStyle=='on') this.unmarkSkill('ghujia');
                                    /*else*/
                            ...
                            if (!this.storage.nohp) {
                                if (hpMax > 5) {
                                    ...
                                    else hpNode.lastChild.classList.remove('lost');
                        ...
                        Player.$give = function(cards, target, log, record) {
                            ...
                            for (var i = 0; i < cards.length; i++) {
                                ...
                                if (card) {
                                    ...
                                    if (hs) {
                                        if (card.throwWith) hs = card.throwWith == 'h' || card.throwWith == 's';
                                        else hs = card.parentNode == player.node.handcards1;
                                    }
                    ...
                    var EventContent = (function(EventContent) {
                                        ...
                                        if (event.openskilldialog) {
                                            ...
                                            if (typeof event.prompt == 'function') {
                                                ...
                                                if (event.source) {
                                                    ...
                                                    handTip.appendText(get.translation(event.getParent()
                                                        .name), 'card');
                                                    tipText = '，' + tipText;
                                                }
                        ...
                        EventContent.equip = function() {
                            ...
                            //-----------------分割线-----------------
                            /*if (lib.config.extension_UIPro_ziqiEquip == true) {
                                if (lib.config.extension_UIPro_newDecadeStyle != 'on') {
						...
						/*EventContent.gain = function () {
							...
							if (event.animate == 'draw') {
								...
								setTimeout(function () {
									game.pause();
									gainTo(cards);
									game.broadcastAll(function (event, player) {
										event.animate(event, player);
									}, event, player);
                        ...
                        EventContent.gameDraw = function() {
                            "step 0"
                            if (_status.brawl && _status.brawl.noGameDraw) return event.goto(4);

                            var end = player;
                            var gainNum = num;
                            do {
                                if (typeof num == 'function') gainNum = num(player);

                                if (player.getTopCards) player.directgain(player.getTopCards(gainNum));
                                else player.directgain(get.cards(gainNum));

                                player.$draw(gainNum);
                                if (player.singleHp === true && get.mode() != 'guozhan' && (lib.config.mode != 'doudizhu' || _status.mode != 'online')) player.doubleDraw();
                        ...
                        EventContent.lose = function() {
                            ...
                            if (event.animate != false) {
                                ...
                                if (lib.config.sync_speed && cards[0] && cards[0].clone) {
                                    ...
                                    else if (pe.getParent()
                                        .discardTransition) evt = pe.getParent();
                    ...
                    ride.lib = {
                        element: {
                                                ...
                                                if (!(e[0].nodeName == "IMG")) {
                                                    ...
                                                    if (subype) {
                                                        for (var i = 0; i < e.length; i++) {
                                                            this.style.top = ""
                                                            if (i == 0) {
                                                                if (colour == 'heart' || colour == 'diamond') e[i].style.color = "#ef1806"; //红色
                                                                else e[i].style.color = "#8DBEDE"; //灰蓝色
                                                                e[i].style.fontSize = "12.6px"; //花色大小
                                                                ...
                                                                if (subype == "equip3" || subype == "equip4") {
                                                                    ...
                                                                    newele.style.height = "85%";
                                                                    newele.style.transform = "scale(1,1.2)";
                                                                    ...
                                                                    e[i].style.color = "#e9e8e3"; //白色
                                                                    e[i].style.position = "absolute";
                                                                    e[i].style.marginLeft = "37.5px"; //装备字体右移
                                                                    e[i].style.marginTop = "1.8px"; //装备字体上下
                                                                }
                                                                e[i].style.fontSize = "15.3px"; //装备字体大小
                                                                e[i].style.transform = "scale(0.9,1.1)";
                                                            }
                                                    ...
                                                    if (subype) {
                                                        for (var i = 0; i < e.length; i++) {
                                                            ...
                                                            if (i == 0) {
                                                                ...
                                                                else e[i].style.color = "#181818"; //黑色
                                                                e[i].style.fontSize = "14px"; //花色大小
                                                        ...
                                                        if (cardName != "liulongcanjia") {
                                                            newele.setAttribute("src", decadeUIPath + "/image/ass/decade/" + subype + ".png")
                                                        } else {
                            ...
                            player: {
                                ...
                                $dieAfter: function() {
                                    if (lib.config.extension_UIPro_dynamicSkin_dieAfter != true) this.stopDynamic();
                                    ...
                                    if (num == 1) {
                                        ...
                                        // num = 0 全部不显示
                                        if (lib.config.extension_UIPro_newDecadeStyle == 'on') {
                                            that.node.dieidentity.innerHTML = '<div style="width:40.2px; height:20px; left:0px; top:-32px; position:absolute; background-image: url(' + lib.assetURL + 'extension/UIPro/assets/image/likai_1.png);background-size: 100% 100%;"></div>';
                                        }

                                        if (lib.config.extension_UIPro_newDecadeStyle == 'off') {
                                            that.node.dieidentity.innerHTML = '<div style="width:21px; height:81px; left:22px; top:-12px; position:absolute; background-image: url(' + lib.assetURL + 'extension/UIPro/assets/image/likai_2.png);background-size: 100% 100%;"></div>';
                                        }

                                        if (lib.config.extension_UIPro_newDecadeStyle == 'othersOn') {
                                            that.node.dieidentity.innerHTML = '<div style="width:21px; height:81px; left:18px; top:-12px; position:absolute; background-image: url(' + lib.assetURL + 'extension/UIPro/assets/image/likai_2.png);background-size: 100% 100%;"></div>';
                                        }
                                    ...
                                    setTimeout(function() {
                                        ...
                                        if (decadeUI.config.playerDieEndEffect) {
                                            decadeUI.animation.playSpine('effect_zhenwang', {
                                                ...
                                                y: decadeUI.get.bodySize()
                                                    .height - rect.top - rect.height / 2 + 1,
                                                scale: 0.8,
                                            });
                                        }
                                    }, 250);
                                ...
                                $syncExpand: function(map) {
                                    ...
                                    ui.equipSolts.back.innerHTML = new Array(5 + Object.values(this.expandedSlots)
                    ...
                    ride.ui = {
                        ...
                        update: function() {
                            ...
                            if ((!ui.dialog.buttons || !ui.dialog.buttons.length) && !ui.dialog.forcebutton && ui.dialog.classList.contains('fullheight') == false && get.mode() != 'stone') {
                                ...
                                if (decadeUI.isMobile()) height = decadeUI.get.bodySize()
                                    .height * 0.75 - 80;
                                else height = decadeUI.get.bodySize()
                                    .height * 0.45;
							...
							buttonPresets: {
                                ...
                                if (node) {
                                    ...
                                    if (node._replaceButton) {
                                        ...
                                        //无名补丁开始
                                        if (_status.connectMode && _status.connectMode === true) intro.innerText = '切换';
                                        else {
                                            if (game.getExtensionConfig('无名补丁', 'enable') && lib.config.extension_无名补丁_xindchoose == true) intro.innerHTML = '<button type="submit" id="but1"></button>';
                                            else intro.innerText = '切换';
                                        }
                                        intro._node = node;
...
/*							confirm: function (str, func) {
                    ...
                    if (decadeModule.modules) for (var i = 0; i < decadeModule.modules.length; i++)
                    ...
                    game.check = function(event) {
                        ...
                        if (event.filterButton) {
                            ...
                            if (ui.selected.buttons.length < range[0]) {
                                ...
                                if (event.complexSelect || event.getParent()
                                    .name == 'chooseCharacter' || event.getParent()
                                    .name == 'chooseButtonOL') {
                                    ok = false;
                                }
                            }
                            if (custom && custom.add.button) {
                                custom.add.button();
                            }
                        }
                        if (event.filterCard) {
                    ...
                    game.swapPlayer = function(player, player2) {
                        ...
                        /*-----------------分割线-----------------*/
                        // 单独装备栏
                        if (lib.config.extension_UIPro_aloneEquip && lib.config.extension_UIPro_newDecadeStyle == 'on') {
                    ...
                    game.swapControl = function(player) {
                        ...
                        /*-----------------分割线-----------------*/
                        // 单独装备栏
                        if (lib.config.extension_UIPro_aloneEquup) {
                            if (game.me && game.me != ui.equipSolts.me) {
                                ui.equipSolts.me.appendChild(ui.equipSolts.equips);
                                ui.equipSolts.me = game.me;
                                ui.equipSolts.equips = game.me.node.equips;
                    ...
                    ui.create.player = function(position, noclick) {
                        ...
                        var playerExtend = {
                            node: {
                                ...
                                equips: ui.create.div('.equips', player)
                                    .hide(),
                    ...
                    ui.create.card = function(position, info, noclick) {
                        ...
                        if (lib.config.extension_UIPro_cardPrettify_suit_number == true) {
                    ...
                    lib.element.content.addJudge = function() {
                        ...
                        if (cards) {
                            ...
                            //开始
                            if (owner) {
                                event.relatedLose = owner.lose(cards, 'visible', ui.special)
                                    .set('getlx', false);
                        ...
                        if (!lib.card[viewAs] || !lib.card[viewAs].effect) {
                            ...
                            if (cards[0].viewAs && cards[0].viewAs != cards[0].name) {
                                ...
                                game.log(player, '被贴上了<font color=\"#FFFF00\">' + get.translation(cards[0].viewAs) + '</font>（', cards, '）');
                            } else {
                            ...
                            if (cards[0].viewAs == 'bingliang' || cards[0].viewAs == 'lebu' || cards[0].viewAs == 'shandian' || cards[0].viewAs == 'caomu'  || cards[0].viewAs == 'fulei'  || cards[0].viewAs == 'hongshui'  || cards[0].viewAs == 'huoshan' ) {
                                ...
                                if (judgeText == "兵" || judgeText == "乐" || judgeText == "闪" || judgeText == "草" || judgeText == "浮" || judgeText == "洪" || judgeText == "火") {
                                    ...
                                    newj.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/assets/image/" + map[judgeText] + ".png" + '")';
                    ...
                    lib.element.content.chooseToCompare = function() {
                        ...
                        if (event.fixedResult && event.fixedResult[player.playerid]) {
                            ...
                            player.send(function(ai) {
                                game.me.chooseCard('请选择拼点牌', true)
                                    .set('prompt', false)
                                    .set('type', 'compare')
                                    .ai = ai;
                                game.resume();
                    ...
                    lib.element.content.chooseToCompareMultiple = function() {
                        ...
                        if (event.list.length || !event.fixedResult || !event.fixedResult[player.playerid]) {
                            ...
                            player.chooseCardOL(event.list, '请选择拼点牌', true)
                                .set('type', 'compare')
                                .set('ai', event.ai)
                                .set('source', player)
                                .aiCard = function(target) {
                    ...
                    lib.element.content.chooseToGuanxing = function() {
                        ...
                        if (this.getParent() && this.getParent()
                            .name && get.translation(this.getParent()
                            .name) != this.getParent()
                            .name) {
                            guanxing.caption = '【' + get.translation(this.getParent()
                                .name) + '】';
                        } else {
...
/*
                ...
                dialog: {
                    ...
                    animate: function(property, duration, toArray, fromArrayOptional) {
                        ...
                        var propArray = property.replace(/\s*/g, '')
                            .split(',');
                ...
                layout: {
                    ...
                    resize: function() {
                        ...
                        if (ui.me) {
                            var height = Math.round(decadeUI.getHandCardSize()
                                .height * decadeUI.zooms.card + 30.4) + 'px';
                ...
                queueNextTick: function(callback, ctx) {
                    ...
                    dui._queueTick = Promise.resolve()
                        .then(function() {
                        dui._queueTick = null;
                    ...
                    switch (event.name.toLowerCase()) {
                        case 'usecard':
                            if (event.targets.length == 1) {
                                if (event.targets[0] == player) tagText = '对自己';
                        ...
                        case 'respond':
							...
							if ((lib.config.cardtempname != 'off') && (card.name != cardname || !get.is.sameNature(card.nature, cardnature, true))) {
                                ...
                                if (cardname == 'huogong') {
                                    ...
                                    if (lib.config.extension_UIPro_cardPrettify != 'off') {
                                        card._tempName.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/image/card/huogong." + lib.config.extension_UIPro_cardPrettify + '")';
                                    }
                                }
                                //属性杀方法1，简洁但不实用
                                /*if (cardname == 'sha') {
							tempname = get.translation(cardnature) + tempname;
							if (lib.config.extension_UIPro_cardPrettify != 'off') {
						    	card._tempName.style.backgroundImage='url("'+lib.assetURL+"extension/UIPro/image/vcard/"+ cardnature +"." + lib.config.extension_UIPro_cardPrettify +'")';
						    }
						}*/
                                //属性杀方法2，代码虽然多了但实用
                                if (cardname == 'sha' && cardnature == 'fire') {
                                    tempname = get.translation(cardnature) + tempname;
                                    if (lib.config.extension_UIPro_cardPrettify != 'off') {
                                        card._tempName.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/image/card/huosha." + lib.config.extension_UIPro_cardPrettify + '")';
                                    }
                                }
                                //雷杀
                                if (cardname == 'sha' && cardnature == 'thunder') {
                                    tempname = get.translation(cardnature) + tempname;
                                    if (lib.config.extension_UIPro_cardPrettify != 'off') {
                                        card._tempName.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/image/card/leisha." + lib.config.extension_UIPro_cardPrettify + '")';
                                    }
                                }
                                //冰杀
                                if (cardname == 'sha' && cardnature == 'ice') {
                                    tempname = get.translation(cardnature) + tempname;
                                    if (lib.config.extension_UIPro_cardPrettify != 'off') {
                                        card._tempName.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/image/card/bingsha." + lib.config.extension_UIPro_cardPrettify + '")';
                                    }
                                }
                                //刺杀
                                if (cardname == 'sha' && cardnature == 'stab') {
                                    tempname = get.translation(cardnature) + tempname;
                                    if (lib.config.extension_UIPro_cardPrettify != 'off') {
                                        card._tempName.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/image/card/cisha." + lib.config.extension_UIPro_cardPrettify + '")';
                                    }
                                }
                                //神杀
                                if (cardname == 'sha' && cardnature == 'kami') {
                                    tempname = get.translation(cardnature) + tempname;
                                    if (lib.config.extension_UIPro_cardPrettify != 'off') {
                                        card._tempName.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/image/card/shensha." + lib.config.extension_UIPro_cardPrettify + '")';
                                    }
                                }
                                //------------定义卡牌名称----------//
                                //开始
							...
							tempname = get.translation(cardname);
                                ...
                                if (cardname) {
                                    ...
                                    if (cardnature != 'fire' && cardnature != 'thunder' && cardnature != 'ice' && cardnature != 'stab' && cardnature != 'kami') {
                                        ...
                                        tempname = get.translation(cardname);
                                        if (lib.config.extension_UIPro_cardPrettify != 'off') {
                                            card._tempName.style.backgroundImage = 'url("' + lib.assetURL + "extension/UIPro/image/card/" + cardname + "." + lib.config.extension_UIPro_cardPrettify + '")';
                                        }
                                    }
                                }
                                //--------------------------//		
                                ...
                                //转标记
                                //card._tempName.innerHTML = '<div style="width:33px; height:31px; left:78px; top:0px; position:absolute; background-image: url(' + lib.assetURL + 'extension/UIPro/image/vcard/zhuan.png);background-size: 100% 100%;"></div>';
                                card._tempName.innerHTML = '<div style="width:33px; height:31px; left:71px; top:5px; position:absolute; background-image: url(' + lib.assetURL + 'extension/UIPro/image/vcard/zhuan.png);background-size: 100% 100%;"></div>';
                                //结束
                                //--------------------------//
                            }
                            ...
                            player: {
                                ...
                                set: function(value) {
                                    ...
                                    if (value == null || value.isUnseen()) {
                                        ...
                                        this.$player.firstChild.style.backgroundImage = (value.isUnseen(0) ? value.node.avatar2 : value.node.avatar)
                            ...
                            target: {
                                ...
                                set: function(value) {
                                    ...
                                    if (value == null || value.isUnseen()) {
                                        ...
                                        this.$target.firstChild.style.backgroundImage = (value.isUnseen(0) ? value.node.avatar2 : value.node.avatar)
                                            .style.backgroundImage;
                                    }
                ...
                loop: function() {
                    ...
                    if (event.next.length > 0) {
                        ...
                        if (next.player && next.player.skipList.contains(next.name)) {
                            ...
                            if (lib.phaseName.contains(next.name)) next.player.getHistory('skipped')
                                .add(next.name);
                        } else {
                            next.parent = event;
                            _status.event = next;
                            game.getGlobalHistory('everything')
                                .push(next);
                        }
                        ...
                        if (event._triggered == 1) {
                            ...
                            if (event.triggerMessage) event.triggerMessage('finished');
        ...
        precontent: function() {
            ...
            lib.arenaReady.push(function() { //联机禁用开始
                if (_status.connectMode === true) {} else {
                    ...
                    if (lib.config['extension_UIPro_qy_shoushatexiao'] && !lib.config['extension_特效测试_enable']) {
                        //此代码已经完全独立重写
                        lib.skill._qy2shousha_jisha = { //十周年
                            trigger: {
                            ...
                            priority: 2021,
                            filter: function(event, player) {
                                return lib.config.extension_UIPro_newDecadeStyle == 'on';
                            },
                            content: function() {
                                if (player.storage._qyshousha_jisha2 == 1) {
                                    ...
                                    game.playAudio('../extension/UIPro/audio/qyjstx_jisha1.mp3');
                                }
                                if (player.storage._qyshousha_jisha2 == 2) {
                                    ...
                                    game.playAudio('../extension/UIPro/audio/qyjstx_jisha2.mp3');
                                }
                                if (player.storage._qyshousha_jisha2 == 3) {
                                    ...
                                    game.playAudio('../extension/UIPro/audio/qyjstx_jisha3.mp3');
                                }
                                if (player.storage._qyshousha_jisha2 == 4) {
                                    ...
                                    game.playAudio('../extension/UIPro/audio/qyjstx_jisha4.mp3');
                                }
                                if (player.storage._qyshousha_jisha2 == 5) {
                                    ...
                                    game.playAudio('../extension/UIPro/audio/qyjstx_jisha5.mp3');
                                }
                                if (player.storage._qyshousha_jisha2 == 6) {
                                    ...
                                    game.playAudio('../extension/UIPro/audio/qyjstx_jisha6.mp3');
                                }
                                if (player.storage._qyshousha_jisha2 >= 7) {
                                    ...
                                    game.playAudio('../extension/UIPro/audio/qyjstx_jisha7.mp3');
                                }
                            },
                        }
                        lib.skill._qy2shousha_jisha3 = { //手杀
                            trigger: {
                                player: '_qyshousha_jisha',
                            },
                            charlotte: true,
                        ...
                        lib.skill._qy2_miaoshouhuichun = {
                            trigger: {
                                player: 'qymiaoshouhuichun'
                            },
                            filter: function(event, player) {
                                return true;
                            },
                            ...
                            content: function() {
                                ...
                                game.playAudio('../extension/UIPro/audio/qy_miaoshouhuichun.mp3');
                            },
                        }
                        lib.skill._qy2_yishugaochao = {
                            trigger: {
                                player: 'qyyishugaochao'
                            },
                            filter: function(event, player) {
                                return true;
                            },
                            ...
                            content: function() {
                                ...
                                game.playAudio('../extension/UIPro/audio/qy_yishugaochao.mp3');
                            },
                        }
                        lib.skill._qy2_recovertrigger = {
                            trigger: {
                                player: ['recoverEnd', '清瑶recoverEnd']
                            },
                            filter: function(event, player) {
                        ...
                        lib.skill._qy2_recovertrigger2 = {
                            trigger: {
                                player: ['recoverBegin', '清瑶recoverBegin']
                            },
                            filter: function(event, player) {
                        ...
                        lib.skill._qy2_onDead = {
                            ...
                            content: function() {
                                game.broadcastAll(function() {
                                    game.playAudio('../extension/UIPro/audio/qy_dead.mp3');
                                });
                            },
                        };
                        lib.skill._qy2_onCause3Damage = {
                            trigger: {
                            ...
                            lastDo: true,
                            filter: function(event, player) {
                                return event.num == 3 && lib.config.extension_UIPro_newDecadeStyle == 'on';
                            },
                            content: function() {
                                game.broadcastAll(function() {
                                    decadeUI.animation.playSpine({
                                        name: "qy_diankuangtulu", //十周年
                                        scale: 0.7,
                                        speed: 0.8,
                                    });
                                    game.playAudio('../extension/UIPro/audio/qy_diankuangtulu.mp3');
                                });
                            },
                        };
                        lib.skill._qy2_onCause4Damage = {
                            trigger: {
                                source: ['damageBegin4', '清瑶DamageBegin4'],
                            },
                            forced: true,
                            ...
                            lastDo: true,
                            filter: function(event, player) {
                                return event.num >= 4 && lib.config.extension_UIPro_newDecadeStyle == 'on';
                            },
                            content: function() {
                                game.broadcastAll(function() {
                                    decadeUI.animation.playSpine({
                                        name: "qy_wushuangwanjunqushou", //十周年
                                        scale: 0.7,
                                        speed: 0.8,
                                    });
                                    game.playAudio('../extension/UIPro/audio/qy_wanjunqushou.mp3');
                                });
                            },
                        };
                        lib.skill._qy2_onCause3Damage2 = {
                            trigger: {
                                source: ['damageBegin4', '清瑶DamageBegin4'],
                            },
                            forced: true,
                        ...
                        lib.skill._qy2_onCause4Damage2 = {
                            trigger: {
                                source: ['damageBegin4', '清瑶DamageBegin4'],
                            },
                            charlotte: true,
        ...
        config: {
            ...
            newDecadeStyle: {
                name: '<b><font color=\"#99FF75\">一键更换全局美化样式',
                intro: '<b><font color=\"#99FF75\">此选项可以切换全局美化特效样式并自动重启（包括武将边框、游戏特效、卡牌、标记、选将框、装备栏等），也可以在其他选项中根据个人喜好自行切换其中某个样式',
                init: 'on',
                item: {
                    on: '<b><font color=gold>十周年',
                    off: '<b><font color=\"#99FF75\">手杀',
                    othersOn: '<b><font color=pink>旧手杀',
                },
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.newDecadeStyle = lib.config['extension_UIPro_newDecadeStyle'];
                },
                onclick: function(value) {
                    game.saveConfig('extension_UIPro_newDecadeStyle', value);
                    if (lib.config.extension_UIPro_newDecadeStyle == 'on') {
                        game.saveConfig('extension_UIPro_shadowStyle', 'on');
                        game.saveConfig('extension_UIPro_playerMarkStyle', 'shizhounian');
                        game.saveConfig('extension_UIPro_cardPrettify', 'jpg');
                        game.saveConfig('extension_UIPro_loadingStyle', 'on');
                        game.saveConfig('extension_UIPro_showJieMark', true);
                        game.saveConfig('extension_UIPro_playerDieEndEffect', true);
                        game.saveConfig('extension_UIPro_playerKillEffect', true);
                    } else {
                        game.saveConfig('extension_UIPro_shadowStyle', 'off');
                        game.saveConfig('extension_UIPro_playerMarkStyle', 'decade');
                        game.saveConfig('extension_UIPro_cardPrettify', 'bmp');
                        game.saveConfig('extension_UIPro_loadingStyle', 'othersOn');
                        game.saveConfig('extension_UIPro_showJieMark', false);
                        game.saveConfig('extension_UIPro_playerDieEndEffect', false);
                        game.saveConfig('extension_UIPro_playerKillEffect', false);
                    }
                    game.reload();
                },
            },
            shadowStyle: {
                name: '<b><font color=pink>切换特效样式',
                intro: '<b><font color=pink>可根据个人喜好切换局内阴影动态特效与人物弹出文字的样式，目前只有新手杀样式可用',
                init: 'on',
                item: {
                    on: '十周年特效',
                    off: '手杀特效',
                ...
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.shadowStyle = lib.config['extension_UIPro_shadowStyle'];
                }
            },
            loadingStyle: {
                name: '<b><font color=gold>更换选项框背景',
                intro: '<b><font color=gold>可以更换局内选项框以及光标',
                init: 'othersOn',
                item: {
                    off: '关闭',
                    on: '<div style="width:60px;height:40px;position:relative;background-image: url(' + lib.assetURL + 'extension/UIPro/assets/image/dialog2.png);background-size: 100% 100%;"></div>', //十周年
                    On: '<div style="width:60px;height:40px;position:relative;background-image: url(' + lib.assetURL + 'extension/UIPro/assets/image/dialog1.png);background-size: 100% 100%;"></div>',
                    othersOn: '<div style="width:60px;height:40px;position:relative;background-image: url(' + lib.assetURL + 'extension/UIPro/assets/image/dialog3.png);background-size: 100% 100%;"></div>', //手杀
                },
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.loadingStyle = lib.config['extension_UIPro_loadingStyle'];
                }
            },
            longLevel: {
                name: '<b><font color=\"#FFBB77\">龙头框等阶',
                init: 'seven',
                item: {
                    one: '银龙',
                    two: '金龙',
                ...
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.longLevel = lib.config['extension_UIPro_longLevel'];
                }
            },
            decadeLayout: {
                name: '<b><font color=\"#AAAAFF\">武将位置布局',
                intro: '<b><font color=\"#AAAAFF\">切换界面布局样式，初始为十周年布局，根据个人喜好自行切换，重启生效',
                init: 'on',
                item: {
                    on: '十周年布局',
                    off: '手杀布局',
                ...
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.decadeLayout = lib.config['extension_UIPro_decadeLayout'];
                }
            },
            eruda: {
                name: '调试助手(开发用)',
            ...
            "qy_shoushatexiao": {
                "name": "手杀击杀特效(联机禁用)",
                "intro": "开启后，游戏内将有手杀或十周年击杀特效。如一破卧龙出山。为避免特效重复，开启特效测试扩展后本功能自动失效。",
                "init": true,
            },
            smoothMode: {
                name: '流畅模式',
            ...
            rightLayout: {
                ...
                init: true,
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.rightLayout = lib.config['extension_UIPro_rightLayout'] ? 'on' : 'off';
                }
            },
            cardPrettify: {
                name: '卡牌美化(自动重启)',
                ...
                item: {
                    off: '关闭',
                    webp: '<b><font color=gold>大将军金卡.webp',
                    bmp: '<b><font color=\"#99FF75\">手杀卡牌.bmp',
                    png: '<b><font color=\"#FFBB77\">十周年卡牌.png',
                    jpg: '<b><font color=pink>彩色卡牌.jpg',
                },
                onclick: function(value) {
                    game.saveConfig('extension_UIPro_cardPrettify', value);
                    game.reload();
                },
            },
            cardPrettify_suit_number: {
                name: '<b>花色点数加粗',
                "intro": "卡牌花色点数加粗，看不清可以打开",
                init: true,
            },
            dynamicBackground: {
                name: '动态背景(损性能)',
                init: 'skin_daqiao_衣垂绿川',
                item: {
                    off: '关闭',
                ...
                update: function() {
                    if (!window.decadeUI) return;
                    var item = lib.config['extension_UIPro_dynamicBackground'];
                    if (!item || item == 'off') {
            ...
            dynamicSkin: {
                name: '动态皮肤(会盖住千幻)',
                "intro": "部分老手机上动皮可能无法正常显示",
                init: true,
                onclick: function() {
                    if (lib.config.extension_UIPro_dynamicSkin == false) {
                        game.saveConfig('extension_UIPro_dynamicSkin', true);
                        if (self.OffscreenCanvas === undefined) {
                            alert("部分老手机上动皮可能无法正常显示。");
                        }
                    } else game.saveConfig('extension_UIPro_dynamicSkin', false);
                }
            },
            ...
            dynamicSkinOutcrop: {
                ...
                update: function() {
                    if (window.decadeUI) {
                        var enable = lib.config['extension_UIPro_dynamicSkinOutcrop'];
            ...
            cardAlternateNameVisible: {
                ...
                init: false,
                update: function() {
                    if (window.decadeUI) ui.window.dataset.cardAlternateNameVisible = lib.config['extension_UIPro_cardAlternateNameVisible'] ? 'on' : 'off';
                }
            },
            ...
            playerKillEffect: {
                ...
                init: false,
                onclick: function(value) {
                    game.saveConfig('extension_UIPro_playerKillEffect', value);
            ...
            playerDieEffect: {
                ...
                init: true,
                onclick: function(value) {
                    game.saveConfig('extension_UIPro_playerDieEffect', value);
            ...
            cardUseEffect: {
                ...
                init: true,
                onclick: function(value) {
                    game.saveConfig('extension_UIPro_cardUseEffect', value);
            ...
            playerLineEffect: {
                ...
                init: true,
                onclick: function(value) {
                    game.saveConfig('extension_UIPro_playerLineEffect', value);
            ...
            outcropSkin: {
                ...
                init: false,
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.outcropSkin = lib.config['extension_UIPro_outcropSkin'] ? 'on' : 'off';
                }
            },
            borderLevel: {
                name: '武将边框等阶',
                ...
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.borderLevel = lib.config['extension_UIPro_borderLevel'];
                }
            },
            gainSkillsVisible: {
                name: '获得技能显示',
                ...
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.gainSkillsVisible = lib.config['extension_UIPro_gainSkillsVisible'];
                }
            },
            playerMarkStyle: {
                name: '技能标记样式',
                ...
                update: function() {
                    if (window.decadeUI) ui.arena.dataset.playerMarkStyle = lib.config['extension_UIPro_playerMarkStyle'];
                            if (game.players) {
                                game.players.forEach(target => {
                                    var skills = target.getSkills()
                                        .filter(i => lib.skill[i] && lib.skill[i].decadeMark);
                                    if (skills.length) skills.forEach(skill => lib.skill[skill].decadeMark(target));
                                });
                            }
                }
            },
            ...
            aloneEquip: {
                ...
                update: function() {
                    if (window.decadeUI) {
                        if (lib.config.extension_UIPro_newDecadeStyle == 'on') ui.arena.dataset.aloneEquip = lib.config['extension_UIPro_aloneEquip'] ? 'on' : 'off';
                        else ui.arena.dataset.aloneEquip = 'off';
                    }
                }
            },
            /*	equipStyle: {
		name: '<b><font color=\"#80FFFF\">装备栏样式(需重启)',
		intro: '<b><font color=\"#80FFFF\">可以根据个人喜欢选择不同的装备栏风格，包括有经典样式与新样式，亦可选择随机调用',
		init: 'off',
		item: {
			on: '十周年装备栏',
			off: '手杀装备栏',
		...
		onclick:function(value){
			game.saveConfig('extension_UIPro_equipStyle', value);
