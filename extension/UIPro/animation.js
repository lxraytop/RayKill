...
decadeModule.import(function(lib, game, ui, get, ai, _status){
	decadeUI.animation = (function(){
		...
		var fileList = [
		    ...
		    { name: 'Xdiankuangtulu' },//手杀癫狂屠戮
		    { name: 'qy_diankuangtulu' },//十周年癫狂屠戮
		    { name: 'Xwushuangwanjunqushou' },//手杀无双万军取首
		    { name: 'qy_wushuangwanjunqushou' },//十周年无双万军取首
		    { name: 'shoushajisha' },//手杀一破到七连的击杀动画
